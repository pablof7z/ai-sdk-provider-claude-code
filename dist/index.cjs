  ...
  return [
    {
      ...
      parameters: (0, import_provider_utils.jsonSchema)(import_zod2.z.object({
        command: import_zod2.z.string().describe("The bash command to execute"),
        description: import_zod2.z.string().optional().describe("Description of what the command does"),
        timeout: import_zod2.z.number().optional().describe("Timeout in milliseconds")
      }))
    },
    {
      type: "function",
      ...
      parameters: (0, import_provider_utils.jsonSchema)(import_zod2.z.object({
        file_path: import_zod2.z.string().describe("Absolute path to the file to read"),
        offset: import_zod2.z.number().optional().describe("Line number to start reading from"),
        limit: import_zod2.z.number().optional().describe("Number of lines to read")
      }))
    },
    {
      type: "function",
      ...
      parameters: (0, import_provider_utils.jsonSchema)(import_zod2.z.object({
        file_path: import_zod2.z.string().describe("Absolute path to the file to write"),
        content: import_zod2.z.string().describe("Content to write to the file")
      }))
    },
    {
      type: "function",
      ...
      parameters: (0, import_provider_utils.jsonSchema)(import_zod2.z.object({
        file_path: import_zod2.z.string().describe("Absolute path to the file to edit"),
        old_string: import_zod2.z.string().describe("Text to replace"),
        new_string: import_zod2.z.string().describe("Text to replace it with"),
        replace_all: import_zod2.z.boolean().optional().describe("Replace all occurrences")
      }))
    },
    {
      type: "function",
      ...
      parameters: (0, import_provider_utils.jsonSchema)(import_zod2.z.object({
        pattern: import_zod2.z.string().describe("Glob pattern to match files"),
        path: import_zod2.z.string().optional().describe("Directory to search in")
      }))
    },
    {
      type: "function",
      ...
      parameters: (0, import_provider_utils.jsonSchema)(import_zod2.z.object({
        pattern: import_zod2.z.string().describe("Regular expression pattern to search for"),
        path: import_zod2.z.string().optional().describe("File or directory to search in"),
        glob: import_zod2.z.string().optional().describe("Glob pattern to filter files"),
        type: import_zod2.z.string().optional().describe("File type to search"),
        output_mode: import_zod2.z.enum(["content", "files_with_matches", "count"]).optional(),
        "-i": import_zod2.z.boolean().optional().describe("Case insensitive search"),
        "-n": import_zod2.z.boolean().optional().describe("Show line numbers"),
        "-A": import_zod2.z.number().optional().describe("Lines of context after match"),
        "-B": import_zod2.z.number().optional().describe("Lines of context before match"),
        "-C": import_zod2.z.number().optional().describe("Lines of context around match")
      }))
    },
    {
      type: "function",
      ...
      parameters: (0, import_provider_utils.jsonSchema)(import_zod2.z.object({
        description: import_zod2.z.string().describe("Short description of the task"),
        prompt: import_zod2.z.string().describe("Detailed task prompt for the agent"),
        subagent_type: import_zod2.z.string().describe("Type of agent to use")
      }))
    },
    {
      type: "function",
      ...
      parameters: (0, import_provider_utils.jsonSchema)(import_zod2.z.object({
        url: import_zod2.z.string().describe("URL to fetch content from"),
        prompt: import_zod2.z.string().describe("What to extract from the content")
      }))
    },
    {
      type: "function",
...
var ClaudeCodeLanguageModel = class _ClaudeCodeLanguageModel {
  ...
  extractToolUses(content) {
    ...
    return content.filter(
      ...
      return {
        id: typeof id === "string" && id.length > 0 ? id : (0, import_provider_utils2.generateId)(),
  ...
  extractToolResults(content) {
    ...
    return content.filter(
      ...
      return {
        id: typeof tool_use_id === "string" && tool_use_id.length > 0 ? tool_use_id : (0, import_provider_utils2.generateId)(),
        ...
        try {
            ...
            if (message.type === "assistant") {
              ...
              if (text) {
                ...
                if (options.responseFormat?.type !== "json") {
                  if (!textPartId) {
                    textPartId = (0, import_provider_utils2.generateId)();
                    controller.enqueue({
                      type: "text-start",
                      id: textPartId
                    });
              ...
              if (options.responseFormat?.type === "json" && accumulatedText) {
                ...
                const jsonTextId = (0, import_provider_utils2.generateId)();
                controller.enqueue({
                  type: "text-start",
                  id: jsonTextId
                });
          ...
          if (isClaudeCodeTruncationError(error, accumulatedText)) {
            ...
            if (options.responseFormat?.type === "json") {
              ...
              const fallbackTextId = (0, import_provider_utils2.generateId)();
              controller.enqueue({
                type: "text-start",
                id: fallbackTextId
              });
